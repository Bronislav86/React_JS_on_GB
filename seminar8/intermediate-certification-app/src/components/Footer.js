...
const Footer = ({ children }) => {
        ...
        if (!children) {
           return(<footer className="footer">
                <h2 style={{display: 'none'}}>Ссылки на наши соцсети</h2>
                <section className="footer__conteiner">
                    <div className="footer__conteiner-leftBox">
                        <h4>&copy;&nbsp;2022 Brand All Rights Reserved.</h4>
                    </div>
                    <div className="footer__conteiner-rightBox">
                        <div className="footer__conteiner-rightBox__icon">
                            {/*// <!--  фэйсбук -->*/}
